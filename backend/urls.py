...
urlpatterns = patterns('',
	...
	url(r'^home-page/centerpieces/update/(?P<pk>[0-9])/$', login_required(CenterpieceUpdateView.as_view()), name="manager-centerpiece-update"),
	url(r'^home-page/announcements/create/$', login_required(AnnouncementCreateView.as_view()), name="manager-announcement-create"),
	url(r'^home-page/announcements/update/(?P<pk>[0-9])/$',login_required(AnnouncementUpdateView.as_view()), name="manager-announcement-update")
)